...
/**
 * JSON body model for registering LRA participant callbacks.
 ...
 * <pre>{@code
 * {
 *   "compensateEndpoint": "kafka://lra-compensate",
 *   "completeEndpoint": "kafka://lra-complete",
 *   "statusEndpoint": null,
 *   "forgetEndpoint": "kafka://lra-forget",
 *   "afterEndpoint": "kafka://lra-afterlra"
 * }
 * }</pre>
 */
