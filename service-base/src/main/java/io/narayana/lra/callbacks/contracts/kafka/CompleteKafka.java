...
import io.narayana.lra.callbacks.contracts.common.Complete;
import java.net.URI;
import org.eclipse.microprofile.lra.annotation.ParticipantStatus;

/**
 * Kafka transport for the participant {@code @Complete} notification.
 */
public class CompleteKafka {
    public static final String TYPE = "complete";

    public static class Request extends Complete.Request {
    ...
    public static class Reply extends Complete.Reply {
        public String correlationId;
        public String error;
